...
uint256 hashGenesisBlock("0x72aba5351bbcbd316037194714797217b53222d2ee65c0f9a10a1414470b807c");
...
static const int64 nTargetTimespan = .10 * 24 * 60 * 60; // TradeCoin: 24 minutes
static const int64 nTargetSpacing = 5; // TradeCoin: 5 Second Blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal tradecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TradeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Today is 6/24/2k13 - shakezula has a hit with BOT!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1372126194; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1358426;
        ...
        assert(block.hashMerkleRoot == uint256("0xe2e1eab6ad6794c98eb03e53f6cee1ee4f33a502040f99c1818198a1a56c00c7"));
